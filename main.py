...
# test only configs/infer_configs/UBFC-rPPG_PURE_TSCAN_BASIC.yaml
...
# "configs/train_configs/UBFC-rPPG_UBFC-rPPG_PURE_PHYSNET_BASIC.yaml"

# configs/train_configs/PURE_PURE_PURE_TSCAN_BASIC.yaml

# configs/train_configs/UBFC-rPPG_UBFC-rPPG_PURE_DEEPPHYS_BASIC.yaml
# configs/train_configs/UBFC-rPPG_UBFC-rPPG_PURE_PHYSFORMER_BASIC.yaml
# configs/train_configs/UBFC-rPPG_UBFC-rPPG_PURE_EFFICIENTPHYS.yaml
...
def add_args(parser):
    ...
    parser.add_argument('--config_file', required=False,
                        default="configs/train_configs/UBFC-rPPG_UBFC-rPPG_PURE_PHYSFORMER_BASIC.yaml", type=str, help="The name of the model.")
...
if __name__ == "__main__":
    ...
    print('Configuration:')
    print(config, end='\n\n')
    print('dropout is:', config.TEST.MC_DROPOUT)
