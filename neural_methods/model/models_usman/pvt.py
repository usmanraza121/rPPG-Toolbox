...
# from pvtv2 import pvt_v2_b2  # for main run
from .pvtv2 import pvt_v2_b2  # for train run
import os
import torch
import torch.nn as nn
import torch.nn.functional as F
...
class PolypPVT(nn.Module):
    def __init__(self, channel=32):
        ...
        path = '/media/usman/disk2/yolop/YOLOP_master/lib/models/transformer_encoder/pretrained_pth/pvt_v2_b2.pth'
