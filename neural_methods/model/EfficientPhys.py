...
class EfficientPhys(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3, dropout_rate1=0.25,
        ...
        self.convx = nn.Conv2d(in_channels=6, out_channels=3, kernel_size=1)  # added by usman to match channel_IN

    def forward(self, inputs, params=None):
        # input1 = inputs[:, :3, :, :]
        # input2 = inputs[:, 3:, :, :]
        input1 = self.convx(inputs)

        inputs = torch.diff(input1, dim=0)
